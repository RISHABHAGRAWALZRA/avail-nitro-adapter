...
type DAConfig struct {
	...
	BridgeApiURL  string        `koanf:"bridge-api-url"`
...
func NewDAConfig(avail_api_url string, bridge_api_url string, seed string, app_id int, timeout time.Duration, vectorx string, arbSepolia_rpc string) (*DAConfig, error) {
	return &DAConfig{
		Enable:        true,
